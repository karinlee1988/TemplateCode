#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Time : 2020/2/12 22:51
# @Author : karinlee
# @FileName : vlookup_gui_v2.py
# @Software : PyCharm
...
class VlookupGui(object):
    ...
    def window(self):
        ...
        # 把标题贴上去，自己修改
        tk.Label(self.master,text="用于进行VLOOKUP操作   作者：李加林",font=("黑体",20)).pack()
    ...
    def frame(self):
        ...
        # 按这个按钮执行主程序
        tk.Button(frame2, text="开始VLOOKUP", command=self.main, font=("黑体", 16)).grid(row=7, column=1,pady=33)
